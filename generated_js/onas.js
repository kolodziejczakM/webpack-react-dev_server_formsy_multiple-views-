...
/***/ function(module, exports, __webpack_require__) {
	...
	var Onas = function (_React$Component) {
	  _inherits(Onas, _React$Component);

	  function Onas() {
	    _classCallCheck(this, Onas);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Onas).apply(this, arguments));
	  }
	  ...
	  _createClass(Onas, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        'We are company, which making websites. Just that.'
	      );
	    }
	  }]);
	...
	exports.default = Onas;


	_reactDom2.default.render(_react2.default.createElement(Onas, null), document.getElementById('render'));
