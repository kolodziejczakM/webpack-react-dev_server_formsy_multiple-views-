...
/******/ 	__webpack_require__.p = "/generated_js/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Register_form = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      { onSubmit: this.submit, onValid: this.enableButton, onInvalid: this.disableButton, className: 'register' },
	      _react2.default.createElement(MyInput, { name: 'register_login', title: 'Login', validations: 'isEmail', validationError: 'Login should be an email. This is not a valid email', required: true }),
	      _react2.default.createElement(MyInput, { name: 'password', title: 'Password', type: 'password', validations: 'minLength:8', validationError: 'Password is too short. ObiApp needs at least 8 chars.', required: true }),
	      _react2.default.createElement(MyInput, { name: 'secret_key', title: 'Secret key', type: 'password', validations: 'minLength:3', validationError: 'Secret key is too short. ObiApp needs at least 3 chars.', required: true }),
	      _react2.default.createElement(
	        'div',
	        { className: 'buttons' },
	        _react2.default.createElement(
	...
	var Login_form = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(MyInput, { name: 'email', title: 'Email', validations: 'isEmail', validationError: 'This is not a valid email', required: true }),
	      _react2.default.createElement(MyInput, { name: 'password', title: 'Password', type: 'password', required: true }),
	      _react2.default.createElement(
	        'div',
	        { className: 'buttons' },
	        _react2.default.createElement(
	  ...
	  _createClass(Index, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(Register_form, null),
	        _react2.default.createElement(
	          'span',
	          null,
	...
	_reactDom2.default.render(_react2.default.createElement(Index, null), document.getElementById('render'));
